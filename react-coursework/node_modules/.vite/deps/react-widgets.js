  ...
  "../node_modules/react/cjs/react.development.js"(exports, module) {
    ...
    (function() {
      ...
      function validateChildKeys(node3) {
        isValidElement(node3) ? node3._store && (node3._store.validated = 1) : "object" === typeof node3 && null !== node3 && node3.$$typeof === REACT_LAZY_TYPE && ("fulfilled" === node3._payload.status ? isValidElement(node3._payload.value) && node3._payload.value._store && (node3._payload.value._store.validated = 1) : node3._store && (node3._store.validated = 1));
      }
      ...
      function mapIntoArray(children, array3, escapedPrefix, nameSoFar, callback) {
        ...
        if (invokeCallback) {
          ...
          isArrayImpl(callback) ? (escapedPrefix = "", null != childKey && (escapedPrefix = childKey.replace(userProvidedKeyEscapeRegex, "$&/") + "/"), mapIntoArray(callback, array3, escapedPrefix, "", function(c) {
            return c;
          ...
          ), "" !== nameSoFar && null != invokeCallback && isValidElement(invokeCallback) && null == invokeCallback.key && invokeCallback._store && !invokeCallback._store.validated && (escapedPrefix._store.validated = 2), callback = escapedPrefix), array3.push(callback));
          return 1;
        }
        invokeCallback = 0;
      ...
      function mapChildren(children, func4, context) {
        if (null == children) return children;
        var result = [], count = 0;
        mapIntoArray(children, result, "", "", function(child) {
          return func4.call(context, child, count++);
        });
        return result;
      }
      ...
      exports.forwardRef = function(render) {
        ...
        var elementType4 = { $$typeof: REACT_FORWARD_REF_TYPE, render }, ownName;
        Object.defineProperty(elementType4, "displayName", {
          enumerable: false,
          configurable: true,
          get: function() {
            return ownName;
